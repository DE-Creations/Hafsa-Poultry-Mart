...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="app-container">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="open-tickets.html"><span>Open
                                                Tickets</span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="pending-tickets.html"><span>Pending
                                                Tickets</span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="closed-tickets.html"><span>Closed
                                                Tickets</span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="solved-tickets.html"><span>Solved
                                                Tickets</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="clients.html"><i class="icon-supervised_user_circle"></i>
                                    Clients
                                </a>
                            </li>
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a class="dropdown-item"
                                            href="form-validations.html"><span>Validations</span></a>
                                    </li>
                                    <li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a class="dropdown-item"
                                            href="calendar-external-draggable.html"><span>Calendar External
                                                Draggable</span>
                                        </a>
                                    </li>
                                    <li>
            ...
            <div class="app-footer text-center">
                <div class="container">
                    <span>© Copyright 2025, All Rights Reserved by DE CREATIONS</span>
                </div>
            </div>
            <!-- App footer end -->
        </div>
    ...
    <script src="assets/vendor/apex/custom/home/tasks.js"></script>
    ...
    <script src="assets/vendor/apex/custom/home/tickets.js"></script>
    <script src="assets/vendor/apex/custom/home/calls.js"></script>
