...
@section('content')
    ...
    <div width="90%" style="margin-left: 5%; margin-top: 25px; border-collapse: collapse;">
        ...
        @if ($expense != 'select')
            <div>
                <span style="padding: 8px; width: 50px">Expense Category :</span>
                <span style="padding: 8px;">{{ $expense }}</span>
            </div>
        @endif
    </div>
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="90%" class="invoice_table"
        ...
        <thead>
            <tr class="row-bg-head"
                ...
                <th width="25%" align="left" style="font-size: 15px;">
                    Code
                </th>
                <th width="25%" align="center" style="font-size: 15px;">
                    Date
                </th>
                <th width="25%" align="center" style="font-size: 15px;">
                    Category
                </th>
                <th width="25%" align="right" style="font-size: 15px;">
                    Amount
                </th>
            </tr>
        </thead>
