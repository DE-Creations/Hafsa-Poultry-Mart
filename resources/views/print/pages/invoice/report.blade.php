suihjd gfaiorsg ndifog
<div class="table-responsive">
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tbody>
            <tr>
                <td style="width: 50%; padding-left: 0;">
                    <div class="text-head" style="color: #000000;">
                        {{--  <b>RECEIPT - {{ $data->invoice }}</b>  --}}
                    </div>
                </td>
            </tr>
            <tr>
                {{--  <td align="left" class="td-customer-style " style="vertical-align:text-top;padding-left: 0;">
                        ...
                        <div style="margin-bottom: 4px;margin-top: 4px;">
                            {{ $payment->member_name }}</div>
                        @isset($payment->member_address)
                            <div style="margin-bottom: 4px;margin-top: 4px;">{{ $payment->member_address }}</div>
                        @endisset
                        @isset($payment->member_email)
                            <div style="margin-bottom: 4px;margin-top: 4px;">{{ $payment->member_email }}</div>
                        @endisset
                        @isset($payment->member_mobile)
                            <div style="margin-bottom: 4px;margin-top: 4px;">{{ $payment->member_mobile }}</div>
                        @endisset
                    </td>  --}}
            </tr>
        </tbody>
