<table class="table table-striped align-middle m-0 text-center">
    ...
    <tbody>
        ...
        <tr class="text-center">
            ...
            <td>{{ $grn->date }}</td>
            <td style="text-align: right; padding-right: 4%;">{{ $grn->sub_total }}</td>
            <td style="text-align: right; padding-right: 4%;">{{ $grn->grnPay->paid_amount}}</td>
            <td style="text-align: right; padding-right: 4%;">{{ $grn->grnPay->new_balance }}</td>
            <td>
