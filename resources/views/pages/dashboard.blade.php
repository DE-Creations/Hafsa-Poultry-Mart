                                    ...
                                    <table class="table truncate align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Unit Testing</td>
                                                <td>
                                                    <span class="badge bg-danger">Feedback</span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge border border-danger text-danger">Validation</span>
                                                    <span class="badge border border-danger text-danger">Fix</span>
                                                </td>
                                                <td>2023/02/12</td>
                                                <td>58 mins ago</td>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="px-0 border-end col-xl-3 col-sm-6">
                                    <div class="text-center">
                                        <p class="m-0 small">Operating Profit</p>
                                        <h3 class="my-2">48%</h3>
                                        <p class="m-0 small">
                                            <span class="badge bg-danger me-1">
                                                <i class="bi bi-arrow-up-right-square"></i>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="m-0">
                                ...
                                <p class="m-0 small fw-light opacity-75">
            ...
            <div class="row gx-3">
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <i
                                class="icon-stacked_line_chart display-3 opacity-25 position-absolute end-0 top-0 me-3"></i>
